...
const RenderSchema = z.object({
    ...
    fog_color: RgbSchema.default([0.0, 0.0, 0.0]).describe('An array of 3 numbers representing the color of the fog.'),
    global_ambient: RgbSchema.default([0.2, 0.2, 0.2]).describe('An array of 3 numbers representing the color of the scene\'s ambient light.'), // Replace with DEFAULT_AMBIENT_COLOR if needed
    ...
    skybox: AssetIdSchema.default(null).describe('The `id` of the cubemap texture to be used as the scene\'s skybox.'),
